...
const data = observable({
	hasData: true,
	line:[
		{id: 1, link: './detail.html', url_img: 'http://static.etouch.cn/imgs/upload/1544105125.1216.png', name: '理疗瑜伽教练培训', introduce:'瑜伽培训相关的课程、学费、老师及学习资讯',buy_num: 3333, original_price: 900, current_price: 800},
	],
	pageSize: 10,
	curPage: 1,
	list:[],
